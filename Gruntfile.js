module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      app_src: {
        ...
        dest: '<%= config.path.dist %>/js/<%= config.destFileName.app_ui_src %>'
      },
      jsLib: {
  ...
  grunt.registerTask('local', ['clean', 'concat:app_src','concat:jsLib', 'concat:config', 'concat:unit', 'concat:unit_config', 'concat:css', 'concat:index', 'copy', 'htmlmin:jsSrc', 'html2js:app_src', 'imagemin']);
  grunt.registerTask('default', ['clean', 'js2coffee', 'concat', 'copy', 'htmlmin:jsSrc', 'html2js:app_src', 'imagemin', 'coffee', 'karma:unit']);
  grunt.registerTask('build', ['clean', 'coffee', 'concat:jsLib', 'concat:css', 'concat:index', 'concat:development', 'copy', 'htmlmin:coffeeSrc', 'html2js:app_src', 'imagemin', 'karma:unit']);
  grunt.registerTask('production', ['clean', 'coffee', 'concat:jsLib', 'concat:css', 'concat:index', 'copy', 'htmlmin:coffeeSrc', 'html2js:app_src', 'imagemin', 'uglify:coffeeJs2min', 'uglify:jsLib', 'uglify:html2js', 'karma:unit']);
